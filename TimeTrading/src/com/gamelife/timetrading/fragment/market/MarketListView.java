...
import com.gamelife.timetrading.R.styleable;
...
public class MarketListView extends ListView {
	...
	public MarketListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(attrs, 0);
	}

	public MarketListView(Context context, AttributeSet attrs, int defStyle) {
	...
	public void setAdapter() {
		//this.adapter = new MarketListViewAdapter(getData());
	...
	private List<Map<String, Object>> getData() {
		...
		map.put("img", R.drawable.ic_home_normal);
		map.put("userid", "G1");
	...
	private void init(AttributeSet attrs, int defStyle) {
		...
		final TypedArray a = getContext().obtainStyledAttributes(attrs,
				R.styleable.MarketListView, defStyle, 0);

		mExampleString = a.getString(R.styleable.MarketListView_exampleString);
		mExampleColor = a.getColor(R.styleable.MarketListView_exampleColor,
				mExampleColor);
		// Use getDimensionPixelSize or getDimensionPixelOffset when dealing
		// with
		// values that should fall on pixel boundaries.
		mExampleDimension = a.getDimension(
				R.styleable.MarketListView_exampleDimension, mExampleDimension);

		if (a.hasValue(R.styleable.MarketListView_exampleDrawable)) {
			mExampleDrawable = a
					.getDrawable(R.styleable.MarketListView_exampleDrawable);
