...
public class FragmentIndicator extends LinearLayout implements OnClickListener {
	...
	//TAB表格只有图标，没有文字
	private View createIndicator(int iconResID, int stringColor, 
			String iconTag, String textTag) {
		LinearLayout view = new LinearLayout(getContext());
		view.setOrientation(LinearLayout.VERTICAL);
		view.setLayoutParams(new LinearLayout.LayoutParams(
	...
	private void init() {
		...
		/*
		mIndicators[0] = createIndicator(R.drawable.ic_market_focused,
				R.string.tab_market, COLOR_SELECT, TAG_ICON_0, TAG_TEXT_0);
		*/
		mIndicators[0] = createIndicator(R.drawable.ic_market_focused,
		...
		/*
		mIndicators[1] = createIndicator(R.drawable.ic_trading_normal,
				R.string.tab_trading, COLOR_UNSELECT, TAG_ICON_1, TAG_TEXT_1);
		*/
		mIndicators[1] = createIndicator(R.drawable.ic_trading_normal,
	...
	public static void setIndicator(int which) {
		...
		case 0:
			...
			prevIcon.setImageResource(R.drawable.ic_market_normal);
		...
		case 1:
			...
			prevIcon.setImageResource(R.drawable.ic_trading_normal);
		...
		case 0:
			...
			currIcon.setImageResource(R.drawable.ic_market_focused);
		...
		case 1:
			...
			currIcon.setImageResource(R.drawable.ic_trading_focused);
